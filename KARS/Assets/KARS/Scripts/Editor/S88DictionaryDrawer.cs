...
namespace Synergy88
{
    ...
    public abstract class S88DictionaryDrawer<TK, TV> : PropertyDrawer
    {
        private S88Dictionary<TK, TV> _Dictionary;
        ...
        private void CheckInitialize(SerializedProperty property, GUIContent label)
        {
            if (_Dictionary == null)
            {
                ...
                _Dictionary = fieldInfo.GetValue(target) as S88Dictionary<TK, TV>;
                if (_Dictionary == null)
                {
                    _Dictionary = new S88Dictionary<TK, TV>();
    ...
    public class SFXAudioMapDrawer : S88DictionaryDrawer<SFX, AudioClip>
    {
    }

    [CustomPropertyDrawer(typeof(BGMAudioMap))]
    public class BGMAudioMapDrawer : S88DictionaryDrawer<BGM, AudioClip>
    {
    }
