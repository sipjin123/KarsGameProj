...
//using CAudioClip = Barangay143.SoundClip;

namespace Synergy88
{

    [Serializable, DebuggerDisplay("Count = {Count}")]
    public class S88Dictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        public S88Dictionary()
            : this(0, null)
        {
        }

        public S88Dictionary(int capacity)
            : this(capacity, null)
        {
        }

        public S88Dictionary(IEqualityComparer<TKey> comparer)
            : this(0, comparer)
        {
        }

        public S88Dictionary(int capacity, IEqualityComparer<TKey> comparer)
        {
            if (capacity < 0)
        ...
        public S88Dictionary(IDictionary<TKey, TValue> dictionary)
            : this(dictionary, null)
        {
        }

        public S88Dictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer)
        ...
        {
            private readonly S88Dictionary<TKey, TValue> _Dictionary;
            ...
            internal Enumerator(S88Dictionary<TKey, TValue> dictionary)
            {
