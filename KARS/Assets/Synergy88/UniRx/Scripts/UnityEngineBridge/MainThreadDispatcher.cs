...
namespace UniRx
{
    public sealed class MainThreadDispatcher : MonoBehaviour
    {
            ...
            else
            {
                ...
                if (dispatcher != null)
                {
                    dispatcher.queueWorker.Enqueue(() =>
                    {
                        ...
                        if (distpacher2 != null)
                        {
                            // [SYNERGY88] 161207 Custom Codes
                            //  Original: distpacher2.StartCoroutine(routine);
                            // ((MonoBehaviour)distpacher2).StartCoroutine(routine);
        ...
        new public static Coroutine StartCoroutine(IEnumerator routine)
        {
            ...
            {
                // [SYNERGY88] 161207 Custom Codes
                //  Original: return dispatcher.StartCoroutine(routine);
                // return ((MonoBehaviour)dispatcher).StartCoroutine(routine);
